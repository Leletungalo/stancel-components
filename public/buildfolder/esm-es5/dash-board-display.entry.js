...
var dashBoardDisplay = /** @class */ (function () {
    ...
    class_1.prototype.connectedCallback = function () {
        var _this = this;
        this.getData().then(function (result) { return _this.data = result; });
    };
    class_1.prototype.getData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("https://tutors123.herokuapp.com/testing#")];
                    case 1:
                        response = _a.sent();
